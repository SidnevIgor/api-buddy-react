  ...
  render() {
    return (
      <div style = {{borderColor: "black", borderStyle: "dashed",width: "100%", height: "600px", display: "inline-block", backgroundColor: "#D3E0E9", fontFamily: "Inter"}}>
        ...
        <p className="lead font-weight-normal" style={{marginLeft: "250px", fontSize: "30px", width:"40%"}}>The service is a free dummy book shop API supporting GET, POST, UPDATE, DELETE requests with the following routes: https://api-buddy/customers</p>
